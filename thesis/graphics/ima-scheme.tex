...
\begin{tikzpicture}
    ...
    \draw[dashed, rounded corners] (0, 5) rectangle node {\textit{point-to-point links}} (15, 5.5);
    ...
    \draw[dashed, rounded corners] (3, -1.5) rectangle node {\textit{shared bus}} (12, -1);
